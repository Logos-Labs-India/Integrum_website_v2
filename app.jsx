...
function buildSearchIndex() {
  const base = [
    ...
    { label:"Reduce your Energy bill", desc:"Cut your energy bill — hybrid, storage, EaaS", go:"cni", kind:"Solutions" },
...
function App() {
  ...
  useEffect(()=>{
    ...
    if (window.gtag) window.gtag("event", "page_view", {
      page_title: title, page_location: url, page_path: page === "home" ? "/" : "/#" + page,
    });
  },[page]);
