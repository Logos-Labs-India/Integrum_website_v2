...
const PERSONAS = [
  { id:"cost", icon:"bolt", title:"Reduce my electricity bill", tag:"Show me my savings potential", lane:"contact", primary:true,
  ...
  { id:"investor", icon:"trendUp", title:"Investor", tag:"Snapshot, financials and governance", lane:"investors",
    ...
    promise:"Commissioned capacity, order book, governance and disclosures — in one place.", next:"Open the investor section" },
